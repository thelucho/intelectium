...
<div class="body-container">
    ...
    <div class="content-container diaadia">
        ...
        <h2 class="nosotros-medio"><?php the_field( 'nosotros_dia_a_dia_titulo' ); ?></h2>
        <?php the_field( 'nosotros_dia_a_dia_descripcion' ); ?>
    </div>


    <div class="content-container">
        <h2 class="nosotros-conoce"><?php the_field( 'nosotros_equipo_titulo' ); ?></h2>

        <?php
        if(ICL_LANGUAGE_CODE=='es'){ ?>
          <p class="nosotros-conoce m-l-50">Conocé más <br class="hidden-md hidden-lg">sobre nosotros</p>
        <?php }

        if(ICL_LANGUAGE_CODE=='en'){ ?>
          <p class="nosotros-conoce m-l-50">More <br class="hidden-md hidden-lg">about us</p>
        <?php } ?>
    ...
    <div class="nosotros-historia">
        <h2 class="nosotros-conoce"><?php the_field( 'nosotros_historia_titulo' ); ?></h2> <p class="nosotros-conoce nosotros-conoce-2"><?php the_field( 'nosotros_historia_subtitulo' ); ?></p>
