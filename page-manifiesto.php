...
<?php get_header(); ?>
    ...
    <div class="body-container">
      ...
      <div class="content-container">
        <h2 class="manifiesto-guion">-</h2><h2 class="manifiesto-titulo-secundario"> <?php the_field( 'manifiesto_sections_insight_titulo' ); ?></h2>
        <p><?php the_field( 'manifiesto_sections_insight_texto' ); ?></p>
      </div>
      <div class="content-container experience">
        <h2 class="manifiesto-guion-par">-</h2><h2  class="manifiesto-par manifiesto-titulo-secundario"> <?php the_field( 'manifiesto_sections_experience_titulo' ); ?></h2>
        <p class="manifiesto-par"><?php the_field( 'manifiesto_sections_experience_texto' ); ?></p>
      </div>
      <div class="content-container">
        <h2 class="manifiesto-guion">-</h2><h2 class="manifiesto-titulo-secundario"> <?php the_field( 'manifiesto_sections_partnership_titulo' ); ?></h2>
        <p><?php the_field( 'manifiesto_sections_partnership_texto' ); ?></p>
      </div>
      <div class="content-container network">
        <h2 class="manifiesto-guion-par">-</h2><h2 class="manifiesto-par manifiesto-titulo-secundario"> <?php the_field( 'manifiesto_sections_network_titulo' ); ?></h2>
