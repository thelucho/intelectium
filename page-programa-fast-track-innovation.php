...
* Template Name: Programa Fast Track Innovation
    ...
    <div class="content-container diaadia">
      ...
      <div class="logos-container">
        ...
        <div class="logo">
          ...
          <?php if ( get_field( 'icono_6') ) { ?>
            <img src="<?php the_field( 'icono_6' ); ?>" class="logo-imagen" />
          <?php } ?>

          <p class="logo-texto"><?php the_field( 'descripcion_bloque_6' ); ?></p>
